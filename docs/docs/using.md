...
**Please note**
Sending GA4 events via the API is not meant to handle all the session information. To take advantage of session tracking and User purchase journey on GA4 console, there are a few steps you must ensure are taken care of:
